class Api::V1::AccountsController < Api::BaseController
  ...
  def update
    @account.assign_attributes(account_params.slice(:name, :locale, :domain, :support_email, :enforced_routing_enabled))
  ...
  def account_params
    params.permit(:account_name, :email, :name, :password, :locale, :domain, :support_email, :user_full_name, :enforced_routing_enabled)
  end
