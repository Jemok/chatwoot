  ...
  def app_config
    {
      ...
      THREADS_APP_ID: GlobalConfigService.load('THREADS_APP_ID', ''),
      X_APP_ID: GlobalConfigService.load('X_APP_ID', ''),
      LINKEDIN_APP_ID: GlobalConfigService.load('LINKEDIN_APP_ID', ''),
