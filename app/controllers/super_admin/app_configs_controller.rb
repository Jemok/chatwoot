class SuperAdmin::AppConfigsController < SuperAdmin::ApplicationController
  ...
  def allowed_configs
    mapping = {
      ...
      'threads' => %w[THREADS_APP_ID THREADS_APP_SECRET THREADS_VERIFY_TOKEN THREADS_API_VERSION],
      'x' => %w[X_CONSUMER_KEY X_CONSUMER_SECRET X_BEARER_TOKEN X_API_VERSION X_ENVIRONMENT_NAME X_WEBHOOK_ID],
      'linkedin' => %w[LINKEDIN_APP_ID LINKEDIN_APP_SECRET LINKEDIN_VERIFY_TOKEN LINKEDIN_API_VERSION],
      'youtube' => %w[YOUTUBE_CLIENT_ID YOUTUBE_CLIENT_SECRET YOUTUBE_API_KEY YOUTUBE_API_VERSION],
